...
// skipping Fuzz_Nosy_OptimismPortal2Filterer_WatchInitialized__ because parameters include func, chan, or unsupported interface: chan<- *github.com/ethereum-optimism/optimism/op-e2e/bindingspreview.OptimismPortal2Initialized

// skipping Fuzz_Nosy_OptimismPortal2Filterer_WatchTransactionDeposited__ because parameters include func, chan, or unsupported interface: chan<- *github.com/ethereum-optimism/optimism/op-e2e/bindingspreview.OptimismPortal2TransactionDeposited

// skipping Fuzz_Nosy_OptimismPortal2Filterer_WatchWithdrawalFinalized__ because parameters include func, chan, or unsupported interface: chan<- *github.com/ethereum-optimism/optimism/op-e2e/bindingspreview.OptimismPortal2WithdrawalFinalized

// skipping Fuzz_Nosy_OptimismPortal2Filterer_WatchWithdrawalProven__ because parameters include func, chan, or unsupported interface: chan<- *github.com/ethereum-optimism/optimism/op-e2e/bindingspreview.OptimismPortal2WithdrawalProven
...
func Fuzz_Nosy_OptimismPortal2Session_Initialize__(f *testing.F) {
	f.Fuzz(func(t *testing.T, data []byte) {
		...
		var _initialRespectedGameType uint32
		fill_err = tp.Fill(&_initialRespectedGameType)
		if fill_err != nil {
			return
		}
		if _OptimismPortal2 == nil {
		...
		_OptimismPortal2.Initialize(_disputeGameFactory, _systemConfig, _superchainConfig, _initialRespectedGameType)
	})
}
...
func Fuzz_Nosy_OptimismPortal2Transactor_Initialize__(f *testing.F) {
	f.Fuzz(func(t *testing.T, data []byte) {
		...
		_OptimismPortal2.Initialize(opts, _disputeGameFactory, _systemConfig, _superchainConfig, _initialRespectedGameType)
	})
}
